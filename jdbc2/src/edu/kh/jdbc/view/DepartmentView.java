...
public class DepartmentView {
	...
	public void displayMenu() {
		...
		do {
			try {
				...
				System.out.println("\n[입력 형식이 잘못되었습니다]\n");
				input = -1; // \while문 안멈추게 값 변경하기
				sc.nextLine(); // 스캐너 버퍼에 남아있는 잘못 입력된 값 비우기(버퍼비우기)
	 ...
	 */
		...
		// DAO 메서드 호출 후 결과(삭제 성공한 행의 개수) 반환 받기
...
//----풀이
	private void deleteDepartment() throws SQLException {
		...
		// 입력받은 부서 코드와 같은 부서 코드를 가지는 행이 있는지 검사
		// -> 있을 경우 "정말 삭제 하시겠습니다?" 한번 더 물어보기
		...
		System.out.println("정말 삭제 하시겠습니다?(Y/N)");
...
/*	private void updateDepartment() throws SQLException {
		...
		Department dept = new Department(deptId,deptTitle);
