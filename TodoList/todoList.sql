...
CREATE TABLE TB_TODO(
	...
	COMPLETE			CHAR(1) DEFAULT 'N'
		CONSTRAINT COMPLET_YN CHECK( COMPLETE IN ('Y', 'N') ),
...
COMMENT ON COLUMN TB_TODO.COMPLETE 		 IS '할 일 완요 여부(Y/N)';
COMMENT ON COLUMN TB_TODO.REG_DATE 		 IS '할 일 등록일';

-- 할 일 번호(TODO_NO) 번호 생성기(SEQUENCE) 만들기

CREATE SEQUENCE SEQ_TODO_NO NOCACHE; -- CACHE

-- 샘플 데이터 추가
INSERT INTO TB_TODO
VALUES(SEQ_TODO_NO.NEXTVAL, '테스트 제목1', '테스트 내용1' 
, DEFAULT, DEFAULT );
